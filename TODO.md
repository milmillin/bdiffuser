...
- [x] `mission_21`: verify corresponding setup/rules text and update `GAME_RULES.md` using Codex-read source images (diff: `Card title updated to `Death by Haggis`; setup/back-rule wording aligned to source images (no setup/rules wording changes beyond title and typo fixes).`).
