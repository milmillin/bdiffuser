...
export function GameBoard({
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ perspective: "1200px" }}>
      <Header gameState={gameState} playerId={playerId} />
...
function Header({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 bg-[var(--color-bomb-surface)] border-b border-gray-700 flex-shrink-0">
