const BUTTON_BASE =
  "px-3 py-1 rounded text-xs font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
...
export const BUTTON_OPTION_CLASS =
  `${BUTTON_BASE} px-4 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-100`;

export const BUTTON_OPTION_SELECTED_CLASS =
  `${BUTTON_BASE} px-4 py-1.5 bg-sky-600 hover:bg-sky-500 text-white`;
